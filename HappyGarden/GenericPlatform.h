...
struct FGenericPlatformTypes 
{
	...
	//A wide character. In-memory only. 
	typedef wchar_t			  WIDECHAR;

	// An 8-bit chracter type. In-memory only. 8-bit representation. Shoould really be char8_t but making this generic option is easier for compilers which don't fully support C++11 yet.
	typedef uint8				 CHAR8;
